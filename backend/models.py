...
class UserManager(BaseUserManager):
    def create_user(self,email,UserID,first_name,last_name,gender,date_of_birth,
                     phone_number='null',address="null",image="null" password=None):
        if not email:
    ...
    def create_superuser(self, email, password):
        user = self.create_user(email,password=password,UserID="null",first_name="TEAM",last_name="LEAD",gender="null",
                          date_of_birth="null",phone_number="null",address="null",image="null")
        user.is_admin = True
        user.staff=True
        user.save(using=self._db)
        return user
...
class BloodPressure(models.Model):
    bloodPressure=models.CharField(verbose_name="blood pressure", max_length=50)
...
class MedicalData(models.Model):
    ...
    temperature=models.ManyToManyField(Temperature, verbose_name="temperature")
    weight=models.ManyToManyField(Weight, verbose_name="weight")
    bloodPressure=models.ManyToManyField(BloodPressure, verbose_name="blood pressure")
...
class Medication(models.Model):
    medicineName=models.CharField(verbose_name="medicine name", max_length=150)
...
class Routine(models.Model):
    ...
    start= models.TimeField(verbose_name="start", auto_now=False, auto_now_add=False)
    end=models.TimeField(verbose_name="end", auto_now=False, auto_now_add=False)
...
class Doctor(models.Model):
    ...
    patients=models.ManyToManyField(Patient, verbose_name="patients")
...
class Patient(models.Model):
    ...
    medicalData=models.ForeignKey(MedicalData, related_name='medical data', on_delete=models.CASCADE)
    medication=models.ManyToManyField(Medication, verbose_name="patients")
    notes=models.ManyToManyField(Notes, verbose_name="notes")
